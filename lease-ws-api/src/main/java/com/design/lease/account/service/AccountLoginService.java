...
@Component
public class AccountLoginService extends ServiceTemplate<AccountBodyVo,UserDetailBO,AccountDetailBO>{
    ...
    public RpcResponseDTO<UserDetailBO> service(Header header,AccountBodyVo accountBodyVo) {
        ...
        accountDto.setAccountName(accountBodyVo.getAccountName());
        accountDto.setPassword(accountBodyVo.getPassword());
        return accountRpcService.login(accountDto);
    }
